...
void ADC_Init(ADC_InitTypeDef *ADC_InitStruct)
{
    ...
    REGBITS_MODIFY(CW_ADC->CR1, ADC_CR1_ALIGN_Msk,
...
void ADC_StructInit(ADC_InitTypeDef *ADC_InitStruct)
{
    ...
    ADC_InitStruct->ADC_VrefSel = ADC_Vref_VDD; //VDD参考电压
 ...
 *          @arg ADC_ExInputCH11
 *          @arg ADC_ExInputCH12
 *          @arg ADC_VddDiv3Input
 *          @arg ADC_TsInput
 *          @arg ADC_Vref1P2Input
 */
void ADC_BufEnSingleCh(uint32_t enAdcSampCh)
{
    if ((enAdcSampCh == ADC_VddDiv3Input) || (enAdcSampCh == ADC_TsInput)
...
{
    if ((enAdcSampCh == ADC_SqrVddDiv3) || (enAdcSampCh == ADC_SqrTs)
