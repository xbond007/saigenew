...
#ifndef __CW32F003_ATIM_H
#define __CW32F003_ATIM_H
...
#define ATIMETR_SOURCE_GPIO                     (0UL)
#define ATIMETR_SOURCE_UART1_RXD                (1UL)
#define ATIMETR_SOURCE_UART2_RXD                (2UL)
#define ATIMETR_SOURCE_VC1                      (4UL)
#define ATIMETR_SOURCE_VC2                      (5UL)
#define ATIMETR_SOURCE_LVD                      (6UL)
#define IS_ATIMETR_SOURCE(SRC)                  ((SRC)==ATIMETR_SOURCE_GPIO||\
                                                (SRC) == ATIMETR_SOURCE_UART1_RXD ||  \
                                                (SRC) == ATIMETR_SOURCE_UART2_RXD || \
                                                (SRC) == ATIMETR_SOURCE_VC1 || \
                                                (SRC) == ATIMETR_SOURCE_VC2 || \
                                                (SRC) == ATIMETR_SOURCE_LVD)

#define ATIMITR_SOURCE_BTIM1                    (0UL)
#define ATIMITR_SOURCE_BTIM2                    (1UL)
#define ATIMITR_SOURCE_BTIM3                    (2UL)
#define ATIMITR_SOURCE_GTIM                     (3UL)
#define IS_ATIMITR_SOURCE(SRC)                  ((SRC)==ATIMITR_SOURCE_BTIM1||\
                                                (SRC) == ATIMITR_SOURCE_BTIM2 ||  \
                                                (SRC) == ATIMITR_SOURCE_BTIM3 || \
                                                (SRC) == ATIMITR_SOURCE_GTIM)
