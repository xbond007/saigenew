...
#ifndef __CW32F003_FLASH_H__
#define __CW32F003_FLASH_H__
...
#define FLASH_FLAG_BSY                          (bv5)/*!<FLASHBusyflag*/
#define FLASH_FLAG_PGERR                        (bv4)/*!<FLASHProgramerrorflag*/
#define FLASH_FLAG_WRPRTERR                     (bv1)/*!<FLASHWriteprotectederrorflag*/
#define FLASH_FLAG_PCERR                        (bv0)/*!<FLASHPCerrorflag*/
#define FLASH_ERROR_ADDR                        0x80

/** @defgroup 读访问周期延时 
  * @{
  */ 
#define FLASH_Latency_1                         ((uint32_t)0x00000000)/*!<FLASHOneLatencycycle*/
#define FLASH_Latency_2                         ((uint32_t)0x00000001)/*!<FLASHTwoLatencycycles*/
#define FLASH_Latency_3                         ((uint32_t)0x00000002)/*!<FLASHTHREELatencycycles*/
...
#define IS_FLASH_GET_IT(IT)                     (((IT)==FLASH_IT_PROG)||\
  ...
  * @{
  */ 
#define FLASH_WRProt_AllPages                   ((uint32_t)0x0000FFFF)/*!<WriteprotectionofallPages*/
#define IS_FLASH_PAGE_Number(PAGENUMBER)        (((PAGENUMBER)>=0)&&((PAGENUMBER)<=39))
#define IS_FLASH_ADDRESS(ADDRESS)               (((ADDRESS)>=0x00000000)&&((ADDRESS)<0x00005000))
