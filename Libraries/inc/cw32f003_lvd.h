...
#ifndef __CW32F003_LVD_H
#define __CW32F003_LVD_H
 ...
 * Global definitions
 ******************************************************************************/
#define LVD_INT_PRIORITY                       ((uint32_t)3)/*VCinterruptpriority(lowestbydefault)*/
...
/** @defgroup LVD_Source
  * @{
  */
#define LVD_Source_VDD                         ((uint32_t)0x00000000)
#define LVD_Source_PB06                        ((uint32_t)0x00000004)
#define LVD_Source_PB03                        ((uint32_t)0x00000008)
#define LVD_Source_PA00                        ((uint32_t)0x0000000C)

#define IS_LVD_SOURCE(SOURCE)                  (((SOURCE)==LVD_Source_VDD)||\
                                               ((SOURCE) == LVD_Source_PB06) || \
                                               ((SOURCE) == LVD_Source_PB03) || \
