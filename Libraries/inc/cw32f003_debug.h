...
#ifndef __CW32F003_DEBUG_H__
#define __CW32F003_DEBUG_H__
...
#define DBGMCU_GTIM_STOP                ((uint32_t)0x00000002)
...
#define IS_DBGMCU_PERIPH(PERIPH)        ((((PERIPH)&0xFFFFF99C)==0x00)&&((PERIPH)!=0x00))
