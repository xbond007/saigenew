...
#ifndef __CW32F003_AWT_H
#define __CW32F003_AWT_H
...
#define AWT_CLKSOURCE_HEX_PB00          (uint32_t)(0x02UL<<8)
#define AWT_CLKSOURCE_HEX_PB01          (uint32_t)(0x03UL<<8)
...
#define IS_AWT_CLKSOURCE(SOURCE)        (((SOURCE)==AWT_CLKSOURCE_HSIOSC)||\
                                        ...
                                        ((SOURCE) == AWT_CLKSOURCE_HEX_PB00) || \
                                        ((SOURCE) == AWT_CLKSOURCE_HEX_PB01) || \
