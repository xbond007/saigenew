...
#ifndef __CW32F003_SYSTICK_H
#define __CW32F003_SYSTICK_H
...
#define TICK_INT_PRIORITY            ((uint32_t)0)/*!<tickinterruptpriority(highestbydefault)*/
