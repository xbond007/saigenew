...
#ifndef __CW32F003_SPI_H
#define __CW32F003_SPI_H
...
/* 中断及标志 */
void SPI_ITConfig(uint8_t SPI_I2S_IT, FunctionalState NewState);
ITStatus SPI_GetITStatus(uint8_t SPI_I2S_IT);
void SPI_ClearITPendingBit(uint8_t SPI_I2S_IT);
